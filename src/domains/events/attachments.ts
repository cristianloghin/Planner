/**
 * Reading and copying what is attached to an event or a blueprint: the
 * checklists and the reminder offsets, and the deep copy a blueprint's
 ...
 * brand-new `checklist_item`/`reminder` rows, never aliasing the source's.
 */
