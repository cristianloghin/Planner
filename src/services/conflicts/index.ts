 ...
 *
 * Given one day's blocks and who is in the account, works out whether each
 * child's block has an adult on it, and if not whether any adult is free to
 * take them. Fed a day at a time; it fetches nothing and knows nothing about
